...
public class MediaSharedElementCallback extends SharedElementCallback {
    ...
    private final List<String> mSharedElementViewNames;

    public MediaSharedElementCallback() {
        mSharedElementViews = new ArrayList<>();
        mSharedElementViewNames = new ArrayList<>();
    }

    public void setSharedElementViews(@NonNull String[]sharedElementViewNames, @NonNull View[] sharedElementViews) {
        mSharedElementViews.clear();
        mSharedElementViewNames.clear();
